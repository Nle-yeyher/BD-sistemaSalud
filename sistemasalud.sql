...
-- Tiempo de generación: 12-03-2025 a las 20:20:28
...
(1, 1, 1, '2025-03-20', '10:00:00', NULL),
(2, 2, 3, '2025-03-21', '11:30:00', NULL),
(3, 3, 2, '2025-03-22', '09:15:00', NULL),
(4, 4, 5, '2025-03-23', '14:00:00', NULL),
...
INSERT INTO `pacientes` (`id_paciente`, `nombre`, `apellido`, `fecha_nacimiento`, `genero`, `direccion`, `telefono`, `correo`, `contraseña`) VALUES
(1, 'Juan', 'Pérez', '1990-05-14', 'M', 'Calle 123', '3001234567', 'juanperez@email.com', 'clave123'),
(2, 'María', 'Gómez', '1985-08-22', 'F', 'Carrera 45', '3017654321', 'mariagomez@email.com', 'clave456'),
(3, 'Carlos', 'López', '2000-02-10', 'M', 'Avenida 89', '3101237890', 'carloslopez@email.com', 'clave789'),
...
(23, 1, 1, 'Tratamiento para la hipertensión', '2025-03-10'),
(24, 2, 3, 'Rehabilitación post-operatoria', '2025-03-11'),
(25, 3, 2, 'Terapia física para lesión en rodilla', '2025-03-12'),
(26, 4, 5, 'Tratamiento para la diabetes', '2025-03-13'),
(27, 5, 4, 'Control y seguimiento de asma', '2025-03-14'),
(28, 6, 1, 'Sesiones de fisioterapia', '2025-03-15'),
(29, 7, 3, 'Terapia respiratoria intensiva', '2025-03-16'),
(30, 8, 2, 'Recuperación tras fractura', '2025-03-17'),
(31, 9, 5, 'Tratamiento para el colesterol alto', '2025-03-18'),
(32, 10, 4, 'Terapia de lenguaje', '2025-03-19'),
(33, 1, 1, 'Manejo de dolor crónico', '2025-03-20'),
(34, 2, 3, 'Programa de nutrición personalizada', '2025-03-21'),
(35, 3, 2, 'Control y seguimiento de hipertensión', '2025-03-22'),
(36, 4, 5, 'Rehabilitación cardiovascular', '2025-03-23'),
(37, 5, 4, 'Tratamiento para la osteoporosis', '2025-03-24'),
(38, 6, 1, 'Evaluación de alergias', '2025-03-25'),
(39, 7, 3, 'Tratamiento para la artritis', '2025-03-26'),
(40, 8, 2, 'Seguimiento postoperatorio', '2025-03-27'),
(41, 9, 5, 'Terapia ocupacional', '2025-03-28'),
(42, 10, 4, 'Tratamiento para migraña crónica', '2025-03-29');
...
--
ALTER TABLE `tratamientos`
  MODIFY `id_tratamiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
